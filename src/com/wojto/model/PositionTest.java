...
class PositionTest {
    ...
    @Test
    void doesPositionLackPurchases() {
        soldShares = createSoldSharesList(5);
        addSharesListToTestedPosition(soldShares);

        assertEquals(true, testedPosition.doesPositionLackPurchases());
    }

    @Test
    void isPositionClosed() {
        boughtShares = createPurchesedSharesList(5);
        soldShares = createSoldSharesList(5);
        addSharesListToTestedPosition(boughtShares);
        addSharesListToTestedPosition(soldShares);

        assertEquals(true, testedPosition.isPositionClosed());
    }
